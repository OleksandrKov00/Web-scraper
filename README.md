...
.py file xlsx_write combines all those parsers and writes down all the data into xlsx table, ending up with dataset describing up to 1k job vacancies rom popular job-posting websites
